...
INSERT INTO orders VALUES (1,1001,to_date('2009-12-20','yyyy-mm-dd'),to_date('2003-12-27','yyyy-mm-dd'),1003,'クレジット');
INSERT INTO orders VALUES (2,1001,to_date('2009-12-21','yyyy-mm-dd'),to_date('2003-12-27','yyyy-mm-dd'),1003,'クレジット');
INSERT INTO orders VALUES (3,1001,to_date('2010-01-10','yyyy-mm-dd'),to_date('2004-01-17','yyyy-mm-dd'),1003,'クレジット');
INSERT INTO orders VALUES (4,1002,to_date('2010-01-11','yyyy-mm-dd'),to_date('2004-01-18','yyyy-mm-dd'),1010,'クレジット');
INSERT INTO orders VALUES (5,1008,to_date('2010-01-15','yyyy-mm-dd'),to_date('2004-01-22','yyyy-mm-dd'),1003,'クレジット');
INSERT INTO orders VALUES (6,1005,to_date('2010-01-20','yyyy-mm-dd'),to_date('2004-01-27','yyyy-mm-dd'),1003,'クレジット');
INSERT INTO orders VALUES (7,1007,to_date('2010-01-22','yyyy-mm-dd'),to_date('2004-01-29','yyyy-mm-dd'),1006,'クレジット');
INSERT INTO orders VALUES (8,1006,to_date('2010-01-22','yyyy-mm-dd'),to_date('2004-01-29','yyyy-mm-dd'),1010,'現金');
INSERT INTO orders VALUES (9,1007,to_date('2010-01-25','yyyy-mm-dd'),to_date('2004-02-03','yyyy-mm-dd'),1006,'クレジット');
INSERT INTO orders VALUES (10,1003,to_date('2010-02-15','yyyy-mm-dd'),to_date('2004-02-22','yyyy-mm-dd'),1003,'クレジット');
INSERT INTO orders VALUES (11,1007,to_date('2010-02-20','yyyy-mm-dd'),to_date('2004-02-27','yyyy-mm-dd'),1006,'クレジット');
